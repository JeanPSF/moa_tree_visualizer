...
public class TaskManagerPanel extends JPanel {
    ...
    protected JPanel treeViewGraphTreePanel = new JPanel();

    protected JPanel treeViewBreadcrumbTreePanel = new JPanel();

    protected JPanel treeViewNodeInfoPanel = new JPanel();

    protected JPanel treeViewSliderPanel = new JPanel();

    protected int treeViewTreeStateStep = 0;

    protected HoeffdingTree.Node[] treeViewTreeStates = null;

    protected JDialog treeViewDialog = null;
    ...
    public void renderTreeView() {
        ...
        treeViewLeftPanel.add(new JTextArea("Teste de Panel Breadcrumb!",3,28));
        ...
        treeViewRightPanel.add(new JTextArea("Teste de Panel Tree View!",3,28));
        treeViewRightPanel.add(new JTextArea("Teste de Panel Slider!",3,28));
        treeViewRightPanel.add(new JTextArea("Teste de Panel Infos!",3,28));
    ...
    public TaskManagerPanel() {
        ...
        this.runTaskButton.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent arg0) {
                //If tree view flag is true

                //new treeViewPanel();
                //renderTreeView();
                /*                treeViewDialog = new JDialog();
                treeViewDialog.setSize(new Dimension(400,100));
                treeViewDialog.setTitle("I got you! You can't click on your JFrame now!");
                treeViewDialog.setModalityType(Dialog.ModalityType.APPLICATION_MODAL); // prevent user from doing something else
    ...
    private static void createAndShowTreeViewGUI() {
        JFrame treeViewFrame2 = new JFrame("treeViewFrame");
        treeViewFrame2.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        // Create and set up the content pane.
        JPanel treeViewPanel2 = new JPanel();
        treeViewPanel2.setOpaque(true); // content panes must be opaque
        treeViewPanel2.setSize(360, 240);
        treeViewPanel2.setBackground(Color.BLUE);
        treeViewPanel2.add(new JTextArea("Teste de Panel do Jean!",3,28));
        treeViewFrame2.setContentPane(treeViewPanel2);

        // Display the windows
        treeViewFrame2.setSize(1280, 720);
        treeViewFrame2.setBackground(Color.RED);
        treeViewFrame2.add(new JTextArea("Teste de Frame do Jean!",3,28));
        treeViewFrame2.pack();
        treeViewFrame2.setLocationByPlatform(true);
        treeViewFrame2.setVisible(true);
/*        // Create and set up the window.
        JFrame frame = new JFrame("Test");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
