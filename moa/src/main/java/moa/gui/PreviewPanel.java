...
public class PreviewPanel extends JPanel implements ResultPreviewListener {
    ...
    public PreviewPanel(TypePanel typePanel, CDTaskManagerPanel taskManagerPanel) {
        ...
        this.autoRefreshComboBox.setSelectedIndex(3); // default to 1 sec
        ...
        this.autoRefreshTimer = new javax.swing.Timer(10000,
                new ActionListener() {
    ...
    public void updateAutoRefreshTimer() {
        ...
        if (autoDelay > 0) {
            ...
            this.autoRefreshTimer.setDelay(autoDelay * 10000);
